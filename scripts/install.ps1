...
Write-Host "  5. One-click launch:     double-click scripts\launch.cmd"
Write-Host "     (or run: powershell -ExecutionPolicy Bypass -File scripts\launch.ps1)"
Write-Host "  6. Desktop shortcut:     .\scripts\install-shortcut.ps1"
Write-Host ""
